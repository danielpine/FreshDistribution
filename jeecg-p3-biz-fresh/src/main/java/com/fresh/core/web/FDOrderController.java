...
public class FDOrderController extends BaseController{
  ...
  private FDOrderService fDOrderService;
	...
	public void list(@ModelAttribute FDOrderEntity query,HttpServletRequest request,HttpServletResponse response,
	...
	public void fDOrderDetail(@RequestParam(required = true, value = "id" ) String id,HttpServletResponse response,HttpServletRequest request)throws Exception{
			VelocityContext velocityContext = new VelocityContext();
